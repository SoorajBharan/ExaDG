...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_RANS_SOLVER_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_RANS_SOLVER_H_

// deal.II
#include <deal.II/base/parameter_handler.h>

// driver
#include <exadg/incompressible_rans/driver.h>
...
// application
#include <exadg/incompressible_rans/user_interface/declare_get_application.h>
...
run(std::string const & input_file, MPI_Comm const & mpi_comm, bool const is_test)
{
  ...
  std::shared_ptr<IncRANS::Driver<dim, Number>> driver =
    std::make_shared<IncRANS::Driver<dim, Number>>(mpi_comm, application, is_test);
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_RANS_SOLVER_H_ */
